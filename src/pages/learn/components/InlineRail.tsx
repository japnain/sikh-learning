function InlineRailChip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      data-testid={testId}
      className={`shrink-0 rounded-full border px-4 py-2.5 font-sans text-xs font-semibold uppercase tracking-[0.18em] transition-all duration-300 touch-manipulation ${
        active
