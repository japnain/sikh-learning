...
export default function CollectionCard({
  ...
  return (
    <Link
      ...
      className={`block w-[17.5rem] shrink-0 snap-start rounded-[30px] border px-4 py-4 text-left transition-all duration-300 ${
        active
    ...
    >
      ...
      <p id={subtitleId} className="mt-1 font-sans text-sm text-ink/58 dark:text-dark-text/58">{collection.subtitle}</p>
      <p id={bodyId} className="mt-3 font-sans text-sm leading-6 text-ink/65 dark:text-dark-text/65">{collection.description}</p>
