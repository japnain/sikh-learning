...
export const MOCK_ARDAAS_BANI_RESPONSE = {
  verses: [
    ...
    createStructuredBaniVerse({
      verseId: 3709,
      shabadId: 24,
      unicode: 'ੴ ਵਾਹਿਗੁਰੂ ਜੀ ਕੀ ਫਤਹ ॥',
      transliteration: 'ik oa(n)kaar vaahiguroo jee kee fateh ||',
      pageNo: 119,
      header: 1,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3710,
      shabadId: 24,
      unicode: 'ਸ੍ਰੀ ਭਗਉਤੀ ਜੀ ਸਹਾਇ ॥',
      transliteration: 'sree bhagautee jee sahaaei ||',
      pageNo: 119,
      header: 1,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3711,
      shabadId: 24,
      unicode: 'ਵਾਰ ਸ੍ਰੀ ਭਗਉਤੀ ਜੀ ਕੀ ॥',
      transliteration: 'vaar sree bhagautee jee kee ||',
      pageNo: 119,
      header: 2,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      ...
      shabadId: 24,
      unicode: 'ਪਾਤਿਸਾਹੀ ੧੦ ॥',
      transliteration: 'paatisaahee 10 ||',
      pageNo: 119,
      header: 2,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3714,
      shabadId: 24,
      unicode: 'ਪ੍ਰਿਥਮ ਭਗੌਤੀ ਸਿਮਰਿ ਕੈ ਗੁਰ ਨਾਨਕ ਲਈਂ ਧਿਆਇ ॥',
      transliteration: 'pritham bhagautee simar kai gur naanak liee(n) dhiaae ||',
      pageNo: 119,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3735,
      shabadId: 24,
      unicode: 'ਨਾਨਕ ਨਾਮ ਚੜ੍ਹਦੀ ਕਲਾ ॥ ਤੇਰੇ ਭਾਣੇ ਸਰਬੱਤ ਦਾ ਭਲਾ ॥',
      transliteration: 'naanak naam chaRhadhee kalaa || tere bhaane sarabat dhaa bhalaa ||',
      pageNo: null,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3736,
      shabadId: 24,
      unicode: 'ਵਾਹਿਗੁਰੂ ਜੀ ਕਾ ਖਾਲਸਾ ॥',
      transliteration: 'vaahiguroo jee kaa khaalasaa ||',
      pageNo: null,
      existsSGPC: 1,
    }),
    createStructuredBaniVerse({
      verseId: 3737,
      shabadId: 24,
      unicode: 'ਵਾਹਿਗੁਰੂ ਜੀ ਕੀ ਫ਼ਤਹਿ ॥',
      transliteration: 'vaahiguroo jee kee fateh ||',
      pageNo: null,
      existsSGPC: 1,
    }),
  ],
...
export const MOCK_AMRIT_SECOND_HEADER_RESPONSE = {
  index: [
    {
      IndexID: 2001,
      HeaderID: 2,
...
function getMockBanidbResponse(url: URL) {
  ...
  if (url.pathname.startsWith('/v2/amritkeertan/index/')) {
    if (url.pathname.endsWith('/2')) return HttpResponse.json(MOCK_AMRIT_SECOND_HEADER_RESPONSE)
