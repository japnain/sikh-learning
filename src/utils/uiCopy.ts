...
const UI_COPY: Record<UiLocale, LocaleCopy> = {
  en: {
    ...
    more: {
      ...
      about: 'About',
      aboutBody: 'NaamRas is a Sikh scripture reading and learning app shaped around three pillars: Read, Understand, and Grow.',
  ...
  pa: {
    ...
    more: {
      ...
      growDescription: 'ਨਾਮਰਸ ਆਰਕਾਈਵ, ਮਾਰਗਦਰਸ਼ਕ ਵਿਸ਼ੇ, ਡੂੰਘੇ ਸ਼ਬਦ ਅਧਿਐਨ ਅਤੇ ਸੰਭਾਲੀਆਂ ਯਾਤਰਾਵਾਂ',
      about: 'ਬਾਰੇ',
      aboutBody: 'ਨਾਮਰਸ ਇੱਕ ਪ੍ਰੀਮੀਅਮ ਗੁਰਬਾਣੀ ਪੜ੍ਹਨ ਅਤੇ ਸਿੱਖਣ ਵਾਲੀ ਐਪ ਹੈ ਜੋ ਰੋਜ਼ਾਨਾ ਵਾਪਸੀ, ਇਮਾਨਦਾਰ ਅਧਿਐਨ ਅਤੇ ਪੰਕਤੀ ਤੋਂ ਜੀਵਨ ਤੱਕ ਲਗਾਤਾਰ ਜੋੜ ਲਈ ਬਣਾਈ ਗਈ ਹੈ।',
  ...
  hi: {
    ...
    more: {
      ...
      growDescription: 'NaamRas आर्काइव, मार्गदर्शक विषय, गहरे शबद अध्ययन और चुनी हुई यात्राएँ',
      about: 'परिचय',
      aboutBody: 'NaamRas एक प्रीमियम गुरबाणी पढ़ने और सीखने की ऐप है जिसे दैनिक वापसी, ईमानदार अध्ययन और पंक्ति से जीवन तक बने रहने वाले संबंध के लिए बनाया गया है।',
