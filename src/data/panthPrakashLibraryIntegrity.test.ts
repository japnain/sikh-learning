...
const REPAIRED_READING_FIXTURES = [
  ...
  { pageNumber: 1102, title: "Bharatpur, Deeg, and Koel Stall Abdali's Advance", anchor: 'Najib Khan worried that Abdali would be trapped before Koel' },
  { pageNumber: 1150, title: 'Rift Between the Khalsa Panth and the Brars', anchor: 'The Majhail Singhs stayed mainly around Jaitu' },
  { pageNumber: 1222, title: "Taruna Dal Misls Move toward Lahore, Nakka, and Multan", anchor: 'The Taruna Dal saw the region around Lahore lying open' },
