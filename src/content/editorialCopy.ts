...
const ENGLISH_EDITORIAL_COPY: EditorialCopy = {
  ...
  learn: {
    ...
    heroSearchHint: "The search stays canonical: it matches you to approved guides, then opens the full context behind them.",
    ...
    proofFooter: "Cross-links matter as much as raw volume. They keep guidance, topic, and shabad study woven together instead of scattered into separate shelves.",
    inventoryLabels: {
    ...
    topicsIntroBody: "Bring the question plainly. NaamRas matches it to canonical guidance and then keeps the full shabad context within reach.",
    topicsSearchPlaceholder: "Search stress, doubt, speech, purpose…",
    shabadsIntroTitle: "Study the full context.",
    shabadsIntroBody: "Filter the archive by theme, Guru, raag, reading depth, and what you have already saved or opened.",
    savedIntroTitle: "Keep what is still working on you.",
    savedIntroBody: "Saved material stays clearly labelled so a line, a guide, and a full shabad never collapse into the same thing.",
  },
  read: {
    eyebrow: "Read",
