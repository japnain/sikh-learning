...
const ENGLISH_EDITORIAL_COPY: EditorialCopy = {
  ...
  learn: {
    ...
    heroBody: "Search the need plainly. NaamRas opens one trustworthy guide, keeps the full shabad in view, and holds the next faithful return close without flattening everything into one tone.",
    heroSearchPlaceholder: "Search anxiety, doubt, seva, hukam…",
    heroSearchHint: "Start with the clearest guide. Then open the scenario that matches the pressure and the shabad that gives it full weight.",
    proofEyebrow: "Reviewed archive",
    proofTitle: "The archive is meant to be used, not merely announced.",
    proofBody: "Counts stay visible, but usefulness comes first: cleaner guidance, truer scenario differences, and links that still hold when you return.",
    proofFooter: "The archive grows by editorial discipline. Distinct guidance, real scenario movement, and trustworthy cross-links matter more than raw volume.",
    inventoryLabels: {
